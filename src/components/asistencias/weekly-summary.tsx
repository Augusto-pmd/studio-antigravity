...
const employeeConverter = {
    ...
    fromFirestore(
        ...
        return {
            ...
            dailyWage: data.dailyWage, // Keep as is, will be parsed defensively
...
const attendanceConverter = {
  ...
  fromFirestore(snapshot: QueryDocumentSnapshot, options: SnapshotOptions): Attendance {
      ...
      return {
          ...
          date: data.date,
          status: data.status,
          lateHours: data.lateHours, // Keep as is, will be parsed defensively
          notes: data.notes,
...
const cashAdvanceConverter = {
    ...
    fromFirestore(snapshot: QueryDocumentSnapshot, options: SnapshotOptions): CashAdvance {
        ...
        return {
            ...
            date: data.date,
            amount: data.amount, // Keep as is, will be parsed defensively
            reason: data.reason,
            payrollWeekId: data.payrollWeekId,
        };
    }
