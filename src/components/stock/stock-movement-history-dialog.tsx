                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            {movements?.map((mov: StockMovement) => {
                                const isIngreso = mov.type === 'CHECK_IN' || mov.type === 'PURCHASE';
                                return (
                                    <TableRow key={mov.id}>
                                        ...
                                        <TableCell className="font-mono">{mov.quantity} {(item as any).unit || ''}</TableCell>
                                        <TableCell>
                                            <div className="text-sm">
                                                {mov.to?.name && <p className="font-medium">{mov.to.name}</p>}
